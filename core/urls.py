...
urlpatterns = [
    ...
    path('requirements/<int:req_id>/claim/', views.claim_requirement, name='claim_requirement'),
    path('requirements/<int:req_id>/approve/', views.approve_requirement, name='approve_requirement'),
    path('requirements/<int:req_id>/reject/', views.reject_requirement, name='reject_requirement'),
    path('hobby/<int:hobby_id>/requirements/add/', views.add_requirement, name='add_requirement'),
    path('requirements/<int:req_id>/update/', views.update_requirement, name='update_requirement'),
    path('requirements/<int:req_id>/delete/', views.delete_requirement, name='delete_requirement'),
    path('requirements/<int:req_id>/link-supplier-item/', views.host_link_supplier_item, name='host_link_supplier_item'),
    path('supplier/requirements/<int:req_id>/<str:decision>/', views.supplier_decide_requirement, name='supplier_decide_requirement'),
    path('supplier/dashboard/', views.supplier_dashboard, name='supplier_dashboard'),
    path('users/<int:user_id>/', views.owner_profile, name='owner_profile'),
